...
class LegacyContextProviderWithUpdates extends Component {
  constructor(props) {
    super(props);
...
class ModernClassContextProviderWithUpdates extends Component {
  constructor(props) {
    super(props);
...
class ModernClassContextConsumerWithUpdates extends Component {
  render() {
    return (
