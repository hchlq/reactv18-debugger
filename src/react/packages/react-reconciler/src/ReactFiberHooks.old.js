...
function mountWorkInProgressHook() {
  ...
  if (workInProgressHook === null) {
    ...
    // 挂载到 workInProgressHook 的下一个，构造成一个链表
  ...
  if (currentHook !== null) {
    ...
    if (nextDeps !== null) {
      ...
      if (areHookInputsEqual(nextDeps, prevDeps)) {
        // 新老依赖一样，增加 effect 队列，但不会增加 effect 的 fiber 标记，因为不需要重新执行该 fiber
