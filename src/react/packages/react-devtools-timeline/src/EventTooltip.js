...
const TooltipReactComponentMeasure = ({componentMeasure}) => {
...
const TooltipFlamechartNode = ({stackFrame}) => {
...
const TooltipNetworkMeasure = ({networkMeasure}) => {
  const {
    finishTimestamp,
...
const TooltipSnapshot = ({height, snapshot, width}) => {
...
const TooltipSuspenseEvent = ({suspenseEvent}) => {
  const {
    componentName,
    duration,
    phase,
...
const TooltipReactMeasure = ({data, measure}) => {
