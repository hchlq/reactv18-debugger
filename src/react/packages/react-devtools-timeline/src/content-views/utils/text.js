...
export function getTextWidth(context, text) {
...
export function trimText(context, text, width) {
...
export function drawText(text, context, fullRect, drawableRect, config) {
  const {
