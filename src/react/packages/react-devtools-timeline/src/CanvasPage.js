...
function CanvasPage({profilerData, viewState}) {
  return (
    <div
...
const zoomToBatch = (data, measure, viewState, width) => {
...
function AutoSizedCanvas({data, height, viewState, width}) {
